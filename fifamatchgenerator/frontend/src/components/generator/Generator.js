            ...
            <Fragment>
                <div className="jumbotron jumbotron-fluid" id="jumbotron">
                    <div className="container" id="jumbotronContainer">
                        ...
                        <p id="disclaimer">This app is not affiliated with or sponsored by Electronic Arts Inc. or its licensors.</p>
                    </div>
                </div>
                ...
                <div id="generatorsDiv" className="grid-container">
                    ...
                    { isAuthenticated ? 
                    <Link to="/login" id="loginLink" >Record your results!</Link> : 
                    <Link to="/login" id="loginLink" >Login to record your results!</Link> }
                </div>
            </Fragment>
        )
    }
